...
Relative to option 2b, this option yields some additional savings in storage space and also has a comparable or perhaps slightly faster run time. The downside is the imprecision of recording only the `value` for the observed category or cdf level in the target data, which may be imprecise.
